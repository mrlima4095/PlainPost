window.onload = () => {
    ...
    document.getElementById("back").addEventListener("click", () => { window.location.href = "/mail"; });   gitea
    document.getElementById("gitea").addEventListener("click", () => { window.location.href = "http://servidordomal.fun:3000/"; });   
